...
class PagesController extends Controller
{
    ...
    public function index(){
        ...
        $currDate = date("Y-m-d");
        $myfile = fopen("../data/" . $currDate . ".txt", "r") or die("Unable to open file!");
        $values = array(array());
        $splitIndex = 0;
        $pos = 0;
        $row = 0;
        ...
        return view('pages.index', ['lava' => $lava, 'values' => $values, 'current' => $numofRows - 1]);
    }
    ...
    public function archive($date){
        ...
        return view('pages.archive', ['lava' => $lava, 'values' => $values, 'date' => $date]);
    }
}
